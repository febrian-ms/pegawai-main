  ...
  <div class="col-12 grid-margin" style="background: #4682B4;">
    <div class="card" style="background: #4682B4;">
      <div class="card-body">
        <div class="row mb-3">
          <div class="col">
            <h4 class="card-title" style="color: #fff;">Daftar Karyawan</h4>
          </div>
          ...
          <div class="col-md-12" style="background: #4682B4;">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group" style="color: #fff;">
                ...
                <input type="text" class="form-control" name="nik" placeholder="Masukan NIK Karyawan" value="" required>
              </div>
              <div class="form-group" style="color: #fff;">
                <label for="exampleInputUsername1">Nama Lengkap</label>
                <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Karyawan" value="" required>
              </div>
              <div class="form-group" style="color: #fff;">
                <label for="exampleInputUsername1">Alamat</label>
                <textarea name="alamat" class="form-control" id="editor" placeholder="Masukan Alamat Karyawan" value="" required></textarea>
              </div>
              <div class="form-group" style="color: #fff;">
              ...
              <div class="text-right">
                <button type="submit" style="background: #000000;" class="btn btn-success text-right" name="submitData">Daftar</button>
              </div>
            </form>
          </div>
        </div>
