					...
					<div class="row">
						<div class="col-md-12 text-white" style="background: #4682B4;">
							...
							<form action="<?php echo base_url(); ?>pegawai/PermohonanCuti/cutiSakit" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="perihal">Sisa Cuti</label>
									<input type="text" class="form-control" id="perihal" aria-describedby="perihal" name="perihal" required value="10" disabled style="width: 60px; font-size: 15px; text-align: left; padding-left: 15px; color: gray;">
								</div>
								<div class="form-group">
