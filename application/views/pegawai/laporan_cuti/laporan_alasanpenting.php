...
<head>
    ...
    <title>Surat Izin Cuti Alasan Penting</title>
...
<body>
    ...
    <p>Lampiran&nbsp;&nbsp;&nbsp; : 1 (Satu) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
    <p>Perihal&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : Surat Izin Cuti Alasan Penting </p>
    <br>
    <p>Nama: <?= $row['nama'] ?></p>
    ...
    <p>Demikian Surat Izin Cuti Alasan Penting ini dibuat untuk dapat digunakan sebagaimana mestinya.
    </p>
    <div class="foot">
        <?php
