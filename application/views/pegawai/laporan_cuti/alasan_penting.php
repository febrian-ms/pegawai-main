        ...
        <div class="table-responsive text-white">
          <table class="table table-white" id="table">
            ...
            <tbody>
              <?php
              $count = 0;
              foreach ($laporan_cutiAlasanPenting as $row) {
                $count = $count + 1;
              ?>
                <tr>
                  ...
                  <td><a class="badge badge-primary" href="<?= base_url('pegawai/LaporanCuti/laporanCutiAlasanPenting/') . $row->kode_pegawai; ?>">CETAK</a></td>
                </tr>
              <?php } ?>
            </tbody>
          </table>
